package com.magic.user.service.config;
...
import com.magic.user.service.config.interceptor.RestTemplateInterceptor;
...
public class MyConfig {
	...
	// declear the bean of OAuth2AuthorizedClient manager
